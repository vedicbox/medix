...
export const STAFF_MEETING_ENDPOINTS = {
  CREATE: `${BASE_URL}/${LOC_POINT.STAFF_MEET}/create`,
  FIND_ALL: `${BASE_URL}/${LOC_POINT.STAFF_MEET}/fetch-all`,
}
...
export const DISEASE_API = {
  ...
  findAll: `${BASE_URL}/${LOC_POINT.DISEASE}/fetch-all`,
  findNames: `${BASE_URL}/${LOC_POINT.DISEASE}/names`,
}

export const SPECs_API = {
  create: `${BASE_URL}/${LOC_POINT.SPECS}/create`,
  udpate: `${BASE_URL}/${LOC_POINT.SPECS}/update`,
  findAll: `${BASE_URL}/${LOC_POINT.SPECS}/fetch-all`,
  findNames: `${BASE_URL}/${LOC_POINT.SPECS}/names`,
}
